...
.feature-card .icon-box {
      ...
      <div class="service-two-slider">
        ...
        <div class="service-block-four" data-bg="images/background/slide2.jpg">
          <div class="inner-box">
            ...
            <div class="overlay-content">
              <div class="count">02 <span>/ 05</span></div>
              <h3 class="title"><a href="restaurant.html">Posadian Restaurant</a></h3>
        ...
        <div class="service-block-four" data-bg="images/background/slide3.jpg">
          <div class="inner-box">
            ...
            <div class="overlay-content">
              <div class="count">03 <span>/ 05</span></div>
              <h3 class="title"><a href="rooftop-bar.html">Aabshaar Lounge</a></h3>
        ...
        <div class="service-block-four" data-bg="images/background/slider4.jpg">
          <div class="inner-box">
            ...
            <div class="overlay-content">
              <div class="count">04 <span>/ 05</span></div>
              <h3 class="title"><a href="banquets.html">Banquet Hall</a></h3>
        ...
        <div class="service-block-four" data-bg="images/background/slide2.jpg">
          <div class="inner-box">
            ...
            <div class="overlay-content">
              <div class="count">05 <span>/ 05</span></div>
              <h3 class="title"><a href="facilities.html">Fitness Center</a></h3>
  ...
  <section id="about" class="about-section-eight pb-0">
        ...
        <div class="content-column col-lg-5 col-xl-4">
          <div class="inner-column">
            <div class="sec-title">
              ...
              <h2>Welcome to Hotel Ranbirs Gomti Nagar</h2>
            ...
            <div class="btn-box">
              ...
              <a href="#contact" class="theme-btn btn-style-three ms-3"><span class="btn-title">Book Now</span></a>
            </div>
          </div>
        </div>
        <!-- Image Column -->
    ...
    <div class="bg-image wow reveal-top tm-gsap-img-parallax overflow-hidden"><img src="images/background/slide3 (1).jpg" alt="Hotel Ranbirs Exterior View"></div>
  </section>
  <!--End About Section -->
          ...
          <div class="service-block-five col-lg-3 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="100ms">
            <div class="inner-box">
              ...
              <div class="content-box">
                ...
                <h3 class="title"><a href="#">Free High-Speed Wi-fi</a></h3>
          ...
          <div class="service-block-five col-lg-3 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="200ms">
            <div class="inner-box">
              ...
              <div class="content-box">
                ...
                <h3 class="title"><a href="#">Secure Parking</a></h3>
          ...
          <div class="service-block-five col-lg-3 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="300ms">
            <div class="inner-box">
              ...
              <div class="content-box">
                ...
                <h3 class="title"><a href="#">Climate Control</a></h3>
          ...
          <div class="service-block-five col-lg-3 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="400ms">
            <div class="inner-box">
              ...
              <div class="content-box">
                ...
                <h3 class="title"><a href="#">24/7 Fitness Center</a></h3>
            ...
            <div class="content-column col-lg-6 col-md-6">
              <div class="inner-column wow fadeInLeft" data-wow-delay="300ms">
                ...
                <div class="btn-box">
                  ...
                  <a href="room-details.html" class="btn-style-five ms-3">View Details</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="outer-box">
        ...
        <div class="info-text">
          <div class="inner-info">
            ...
            <a href="restaurant.html" class="link">View Menu & Details <i class="icon fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="banquet" class="about-section-eight pb-0">
    <div class="outer-box">
      <div class="row">
        ...
        <div class="content-column col-lg-5 col-xl-4">
          <div class="inner-column">
            ...
            <div class="btn-box">
              ...
              <a href="banquets.html" class="theme-btn btn-style-three ms-3"><span class="btn-title">View Halls</span></a>
            </div>
          </div>
        </div>
        <!-- Image Column -->
        <div class="image-column col-lg-7 col-xl-8">
          <div class="inner-column">
            <figure class="image-1 overlay-anim wow reveal-right tm-gsap-img-parallax overflow-hidden"><img src="images/resource/about8-1.jpg" alt="Banquet Hall at Hotel Ranbirs"></figure>
            <figure class="image-2 wow reveal-right tm-gsap-img-parallax overflow-hidden">
              <img src="images/resource/about8-2.jpg" alt="Wedding Setup at Hotel Ranbirs">
              <img src="images/resource/about8-3.jpg" alt="Corporate Event at Hotel Ranbirs">
            </figure>
          </div>
        </div>
      </div>
              ...
              <form method="post" action="#" id="contact-form">
                <div class="row">
                  ...
                  <div class="form-group col-lg-12">
                    <textarea name="message" placeholder="Special Requests (Dietary, Accessibility, etc.)" rows="2"></textarea>
                  </div>
                  <div class="form-group col-lg-12">
                    <button type="submit" class="theme-btn btn-style-two" name="submit-form"><span class="btn-title">Submit Booking Request</span></button>
                  </div>
                </div>
              </form>
            </div>
    ...
    <div class="auto-container">
      ...
      <div class="client-slider wow fadeInUp"> 
        ...
        <div class="client-block-two">
          <div class="inner-box">
            <figure class="image"><a href="#"><img src="images/resource/client1-1.png" alt="Taj Hotels Partner"></a></figure>
          </div>
        </div>
        <!-- client-block -->
        <div class="client-block-two">
          <div class="inner-box">
            <figure class="image"><a href="#"><img src="images/resource/client1-2.png" alt="MakeMyTrip Partner"></a></figure>
          </div>
        </div>
        <!-- client-block -->
        <div class="client-block-two">
          <div class="inner-box">
            <figure class="image"><a href="#"><img src="images/resource/client1-3.png" alt="OYO Partner"></a></figure>
          </div>
        </div>
        <!-- client-block -->
        <div class="client-block-two">
          <div class="inner-box">
            <figure class="image"><a href="#"><img src="images/resource/client1-4.png" alt="Zomato Partner"></a></figure>
          </div>
        </div>
        <!-- client-block -->
        <div class="client-block-two">
          <div class="inner-box">
            <figure class="image"><a href="#"><img src="images/resource/client1-5.png" alt="Swiggy Partner"></a></figure>
          </div>
        </div>
      </div>
    </div>
