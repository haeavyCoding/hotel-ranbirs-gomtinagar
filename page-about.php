	...
	<section class="page-title" style="background-image: url(images/background/page-title-bg.png);">
		<div class="auto-container">
			<div class="title-outer text-center">
				<h1 class="title" class="title" style="color: var(--theme-color1);">Welcome to Hotel Ranbirs, Gomti Nagar, Lucknow</h1>
    ...
    <div class="auto-container">
      ...
      <div class="row feature-row g-0">
        ...
        <div class="image-column col-lg-6">
          <div class="inner-column">
            <div class="image-box">
              <figure class="image overlay-anim wow reveal-left"><img src="images/resource/feature2-2.jpg" alt="Hotel Ranbirs Banquet Hall"></figure>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="testimonial-block-five col-lg-4 col-sm-6">
          <div class="inner-box">
            ...
            <div class="info-box">
              <figure class="thumb"><img src="images/resource/testi2-thumb1.png" alt="Guest"></figure>
              <div>
        ...
        <div class="testimonial-block-five col-lg-4 col-sm-6">
          <div class="inner-box">
            ...
            <div class="info-box">
              <figure class="thumb"><img src="images/resource/testi2-thumb2.png" alt="Guest"></figure>
              <div>
