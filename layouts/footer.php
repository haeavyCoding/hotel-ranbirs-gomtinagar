      ...
      <div class="row">
        ...
        <div class="footer-column col-lg-4 col-sm-6">
          <div class="footer-widget about-widget wow fadeInLeft">
            <div class="widget-content">
              <div class="logo"><a href="index.php"> <img src="images/logo-transparent-removebg-preview.png"
                    alt="Hotel Ranbirs"></a></div>
              <div class="text mb-0">One of the top hotels in Lucknow located in Gomti Nagar, offering luxury
                accommodations and world-class services in the heart of the City of Nawabs.</div>
            </div>
          </div>
          ...
          <div class="footer-widget widget-social wow fadeInLeft" data-wow-delay="300ms">
            ...
            <div class="widget-content">
              <ul class="social-icon">
                ...
                <li><a href="https://www.instagram.com/ranbirshotel/?hl=en"><i class="fa-brands fa-instagram"></i></a>
                </li>
                <li><a href="https://in.linkedin.com/in/ranbirs-hotel-gomitinagar-a2343a359"><i
                      class="fa-brands fa-linkedin"></i></a></li>
                <li>
                  <a href="https://wa.me/919876543210?text=Hello" target="_blank" title="Chat on WhatsApp">
          ...
          <div class="footer-widget links-widget ps-xl-5 wow fadeInLeft" data-wow-delay="200ms">
            ...
            <div class="widget-content">
              <ul class="user-links">
                ...
                <li><a href="page-rooms.php">Room Service</a></li>
                <li><a href="meetings.php">Meeting Rooms</a></li>
                <li><a href="#services">Gymnasium</a></li>
                <li><a href="#contact">Travel Desk</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="footer-column col-lg-3 col-sm-6">
          <div class="footer-widget info-widget ps-xl-5 ms-xl-5 mb-30 wow fadeInLeft" data-wow-delay="300ms">
            <h4 class="widget-title">Hotel Ranbirs</h4>
            <div class="widget-content">
              <!-- Contact List -->
              <div class="contact-list">
                <div class="inner">
                  ...
                  <div class="list-info"><a href="mailto:info@hotelranbirs.com"
                      class="list-info">info@hotelranbirs.com</a></div>
                </div>
              </div>
            </div>
          </div>
          <div class="footer-widget info-widget ps-xl-5 ms-xl-5 wow fadeInLeft" data-wow-delay="300ms">
            ...
            <div class="widget-content">
              ...
              <div class="contact-list">
                <div class="inner">
                  <div class="list-info">Reception: 24/7</div>
                  <div class="list-info">Restaurant: 7:00 AM - 11:00 PM</div>
                  <div class="list-info">Bar: 12:00 PM - 11:00 PM</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="footer-bottom">
    <div class="auto-container">
      <div class="inner-container text-center">
        <div class="copyright-text">© 2025 <span>Hotel Ranbirs</span>. All Rights Reserved by <a class="text-white"
            href="https://yashinfosystem.com/">Yash Infosystem</a></div>
      </div>
    </div>
  </div>
</footer>
...
<!-- Mirrored from html.kodesolution.com/2025/hoteler-html/index-12-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 May 2025 08:36:22 GMT -->
